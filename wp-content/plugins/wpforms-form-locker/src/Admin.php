	...
	public function admin_builder_enqueues() {
		...
		wp_localize_script(
			...
			[
				...
				'start_date_required_title'          => esc_html__( 'Start Date Required', 'wpforms-form-locker' ),
				'start_date_required_content'        => esc_html__( 'You must specify a start date.', 'wpforms-form-locker' ),
				'end_date_required_title'            => esc_html__( 'End Date Required', 'wpforms-form-locker' ),
				'end_date_required_content'          => esc_html__( 'You must specify an end date.', 'wpforms-form-locker' ),
				'start_end_date_required_title'      => esc_html__( 'Start/End Date Required', 'wpforms-form-locker' ),
				'start_end_date_required_content'    => esc_html__( 'You must specify a start and end date.', 'wpforms-form-locker' ),
			]
		);
		...
		echo '<div class="wpforms-panel-content-section wpforms-panel-content-section-form_locker">';
			...
			wpforms_panel_fields_group(
				...
				[
					...
					'class'       => 'wpforms-form-locker-verification-group',
				]
			);
			...
			$smtp_education_notice = wpforms()->obj( 'education_smtp_notice' );
			...
			wpforms_panel_field(
				...
				[
					...
					'after'   => method_exists( $smtp_education_notice, 'get_template' ) ? $smtp_education_notice->get_template() : '',
				]
			);
			...
			wpforms_panel_field(
				...
				[
					...
					'input_class' => 'wpforms-datepair-date wpforms-datepair-start',
					'after'       => '<button type="button" class="wpforms-clear-datetime-field" title="' . esc_attr__( 'Clear Start Date', 'wpforms-form-locker' ) . '"><i class="fa fa-times-circle"></i></button>',
				]
			);
			...
			wpforms_panel_field(
				...
				[
					...
					'after'       => '<button type="button" class="wpforms-clear-datetime-field" title="' . esc_attr__( 'Clear Start Time', 'wpforms-form-locker' ) . '"><i class="fa fa-times-circle"></i></button>',
				]
			);
			...
			wpforms_panel_field(
				...
				[
					'class'       => 'wpforms-panel-field-datetime wpforms-panel-field-half',
					'input_class' => 'wpforms-datepair-date wpforms-datepair-end',
					'after'       => '<button type="button" class="wpforms-clear-datetime-field" title="' . esc_attr__( 'Clear End Date', 'wpforms-form-locker' ) . '"><i class="fa fa-times-circle"></i></button>',
				]
			);
			...
			wpforms_panel_field(
				...
				[
					...
					'after'       => '<button type="button" class="wpforms-clear-datetime-field" title="' . esc_attr__( 'Clear End Time', 'wpforms-form-locker' ) . '"><i class="fa fa-times-circle"></i></button>',
				]
			);
